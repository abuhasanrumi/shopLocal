...
const ShippingPolicy = () => {
    return (
        <>
            <Meta title={"Shipping Policy - ShopLocal"} />
            <BreadCrumb title={"Shipping Policy - ShopLocal"} />
            <div className="shipping-policy-wrapper gray-bg">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12 p-5">
                            <div className="shipping-policy-texts">
