...
const RefundPolicy = () => {
    return (
        <>
            <Meta title={"Refund Policy - ShopLocal"} />
            <BreadCrumb title={"Refund Policy - ShopLocal"} />
            <div className="refund-policy-wrapper gray-bg">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12 p-5">
                            <div className="refund-policy-texts">
