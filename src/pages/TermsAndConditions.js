...
const TermsAndConditions = () => {
    return (
        <>
            <Meta title={"Terms and Conditions - ShopLocal"} />
            <BreadCrumb title={"Terms and Conditions - ShopLocal"} />
            <div className="terms-condition-wrapper gray-bg">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12 p-5">
                            <div className="terms-condition-texts">
